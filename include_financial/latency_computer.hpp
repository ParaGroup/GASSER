 ...
 ****************************************************************************
 *
 * Athors:  Gabriele Mencagli <mencagli at di.unipi.it>
 *	    Tiziano De Matteis <dematteis at di.unipi.it>
 */
...
public:
	...
	bool compute(const toy_winresult_t &res)
	{
	...
	bool compute(const winresult_t &res) {
...
private:
	const long long initial_timestamp;
	FILE *fout;
	double cumlat;
